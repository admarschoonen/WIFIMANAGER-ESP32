...
const char WM_HTTP_HEAD_REFRESH[] PROGMEM =
    "<meta http-equiv=\"refresh\" content=\"1; url=/0wifi\" />";
const char WM_HTTP_BODY_REFRESH[] PROGMEM =
    "<p>Click <a href=\"/0wifi\">here</a> if this page does not refresh after "
    "5 seconds.</p>";
...
const char WM_HTTP_CHANGE_NAME_ERROR_MSG[] PROGMEM =
    "<p>Invalid name. Please use only letters ('a'-'z'), numbers ('0'-'9') and "
    "hyphen ('-') characters.</p>";
const char WM_HTTP_CHANGE_NAME_FORM_START[] PROGMEM =
    "<p>Enter a new name for this device:<br><form method='get' "
    "action='savename'><input id='n' name='n' length=32 placeholder='{p}'></p>";
const char WM_HTTP_CHANGE_NAME_FORM_END[] PROGMEM =
    "<br/><button type='submit'>save</button></form>";
const char WM_HTTP_SCAN_LINK[] PROGMEM =
    "<br/><div class=\"c\"><a href=\"/wifi\">Scan</a></div>";
const char WM_HTTP_SAVED[] PROGMEM =
    "<div>Credentials Saved<br />Trying to connect {h} to network \"{n}\".<br "
    "/>If it fails reconnect to AP to try again</div>";
...
class WiFiManager {
 public:
  ...
  // setup. useful for devices that failed to connect at some point and got
 ...
 private:
  ...
  // const String  WM_HTTP_HEAD = "<!DOCTYPE html><html lang=\"en\"><head><meta
